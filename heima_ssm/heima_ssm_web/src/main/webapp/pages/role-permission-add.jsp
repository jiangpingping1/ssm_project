...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form
				action="${pageContext.request.contextPath}/role/savePermission.do"
				method="post">
				<!-- 正文区域 -->
								...
								<c:forEach items="${permissions}" var="permission">
									<tr>
										<td>
											...
											<input name="ids" type="checkbox" <c:if test="${permission.status==1}">checked</c:if> value="${permission.id}">
